...
$$
M_\theta =
\left(S,A,P(s'\mid s,a),u_\theta(s,a),\beta,\sigma\right)
$$
:::
...
$$
Q_\theta(s,a)
= u_\theta(s,a)+\beta\sum_{s'\in S}P(s'\mid s,a)V_\theta(s')
$$
:::

::: {.eqbox}
$$
V_\theta(s)=\sigma\log\sum_{b\in A(s)}
...
M_{cf}
=
\left(S,A_{cf},P_{cf},u_{cf},\beta_{cf},\sigma\right)
$$
:::
...
(V_{cf},Q_{cf},\pi_{cf})
=
\operatorname{SolveBellman}(M_{cf})
$$
:::
